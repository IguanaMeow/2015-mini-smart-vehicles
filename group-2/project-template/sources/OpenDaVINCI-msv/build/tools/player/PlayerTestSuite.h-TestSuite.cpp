...
int main() {
 return CxxTest::XmlFilePrinter("/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/build/tools/player/PlayerTestSuite.h-TestSuite.cpp-TestSuiteReport.xml").run();
}
#include "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/tools/player/testsuites/PlayerTestSuite.h"

static PlayerModuleTest suite_PlayerModuleTest;

static CxxTest::List Tests_PlayerModuleTest = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_PlayerModuleTest( "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/tools/player/testsuites/PlayerTestSuite.h", 102, "PlayerModuleTest", suite_PlayerModuleTest, Tests_PlayerModuleTest );
