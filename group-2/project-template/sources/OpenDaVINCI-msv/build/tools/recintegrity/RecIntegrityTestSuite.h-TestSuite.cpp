...
int main() {
 return CxxTest::XmlFilePrinter("/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/build/tools/recintegrity/RecIntegrityTestSuite.h-TestSuite.cpp-TestSuiteReport.xml").run();
}
#include "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/tools/recintegrity/testsuites/RecIntegrityTestSuite.h"

static RecIntegrityTest suite_RecIntegrityTest;

static CxxTest::List Tests_RecIntegrityTest = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_RecIntegrityTest( "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/tools/recintegrity/testsuites/RecIntegrityTestSuite.h", 49, "RecIntegrityTest", suite_RecIntegrityTest, Tests_RecIntegrityTest );
