...
int main() {
 return CxxTest::XmlFilePrinter("/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/build/tools/split/SplitTestSuite.h-TestSuite.cpp-TestSuiteReport.xml").run();
}
#include "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/tools/split/testsuites/SplitTestSuite.h"

static SplitTest suite_SplitTest;

static CxxTest::List Tests_SplitTest = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_SplitTest( "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/tools/split/testsuites/SplitTestSuite.h", 86, "SplitTest", suite_SplitTest, Tests_SplitTest );
