...
int main() {
 return CxxTest::XmlFilePrinter("/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/build/apps/VCR/VCRTestSuite.h-TestSuite.cpp-TestSuiteReport.xml").run();
}
#include "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/apps/VCR/testsuites/VCRTestSuite.h"

static VCRTest suite_VCRTest;

static CxxTest::List Tests_VCRTest = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_VCRTest( "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/apps/VCR/testsuites/VCRTestSuite.h", 66, "VCRTest", suite_VCRTest, Tests_VCRTest );
