...
int main() {
 return CxxTest::XmlFilePrinter("/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/build/supercomponent/ManagedLevelTestSuite.h-TestSuite.cpp-TestSuiteReport.xml").run();
}
#include "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/supercomponent/testsuites/ManagedLevelTestSuite.h"

static ManagedLevelTest suite_ManagedLevelTest;

static CxxTest::List Tests_ManagedLevelTest = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_ManagedLevelTest( "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/supercomponent/testsuites/ManagedLevelTestSuite.h", 299, "ManagedLevelTest", suite_ManagedLevelTest, Tests_ManagedLevelTest );
