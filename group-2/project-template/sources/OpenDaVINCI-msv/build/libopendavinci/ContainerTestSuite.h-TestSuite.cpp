...
int main() {
 return CxxTest::XmlFilePrinter("/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/build/libopendavinci/ContainerTestSuite.h-TestSuite.cpp-TestSuiteReport.xml").run();
}
#include "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/libopendavinci/testsuites/ContainerTestSuite.h"

static ContainerTest suite_ContainerTest;

static CxxTest::List Tests_ContainerTest = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_ContainerTest( "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/libopendavinci/testsuites/ContainerTestSuite.h", 33, "ContainerTest", suite_ContainerTest, Tests_ContainerTest );
