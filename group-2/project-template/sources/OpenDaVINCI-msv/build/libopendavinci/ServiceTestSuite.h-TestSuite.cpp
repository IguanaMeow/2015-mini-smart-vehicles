...
int main() {
 return CxxTest::XmlFilePrinter("/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/build/libopendavinci/ServiceTestSuite.h-TestSuite.cpp-TestSuiteReport.xml").run();
}
#include "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/libopendavinci/testsuites/ServiceTestSuite.h"

static ServiceTest suite_ServiceTest;

static CxxTest::List Tests_ServiceTest = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_ServiceTest( "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/libopendavinci/testsuites/ServiceTestSuite.h", 97, "ServiceTest", suite_ServiceTest, Tests_ServiceTest );
