...
int main() {
 return CxxTest::XmlFilePrinter("/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/build/libopendavinci/ConnectionTestSuite.h-TestSuite.cpp-TestSuiteReport.xml").run();
}
#include "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/libopendavinci/testsuites/ConnectionTestSuite.h"

static ConnectionTestsuite suite_ConnectionTestsuite;

static CxxTest::List Tests_ConnectionTestsuite = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_ConnectionTestsuite( "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/libopendavinci/testsuites/ConnectionTestSuite.h", 51, "ConnectionTestsuite", suite_ConnectionTestsuite, Tests_ConnectionTestsuite );
