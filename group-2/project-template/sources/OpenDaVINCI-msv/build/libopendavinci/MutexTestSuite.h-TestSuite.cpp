...
int main() {
 return CxxTest::XmlFilePrinter("/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/build/libopendavinci/MutexTestSuite.h-TestSuite.cpp-TestSuiteReport.xml").run();
}
#include "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/libopendavinci/testsuites/MutexTestSuite.h"

static MutexTest suite_MutexTest;

static CxxTest::List Tests_MutexTest = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_MutexTest( "/home/msv/Desktop/project-template/sources/OpenDaVINCI-msv/libopendavinci/testsuites/MutexTestSuite.h", 47, "MutexTest", suite_MutexTest, Tests_MutexTest );
