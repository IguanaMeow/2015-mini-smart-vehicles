...
*/
                ...
                /* Start steering back to the right lane once the front right infrared AND rear right infrared sensor detect nothing. */
             	else if(vd.getAbsTraveledPath() > 42 && sbd.getValueForKey_MapOfDistances(0) < 0 && 			sbd.getValueForKey_MapOfDistances(2) < 0){
