...
// With setSpeed you can set a desired speed for the vehicle in the range of -2.0 (backwards) .. 0 (stop) .. +2.0 (forwards)
                        ...
                        if (vd.getAbsTraveledPath() >= count + 2 && sbd.getValueForKey_MapOfDistances(0) < 0){

                                park = true;
                               /* 
                                if(vd.getAbsTraveledPath() >= 9){
                                angle = 1000;
                                vc.setSpeed(-1);
                                vc.setAcceleration(1);
                                }
                                    ...
                                    //if (sbd.getValueForKey_MapOfDistances(1) > 0){
                                      //      vc.setSpeed(0);
                                      //   }
                         }  
                        ...
                        if (sbd.getValueForKey_MapOfDistances(2) > 0 && park == false){
                         ...
                         if (park == true){
                            ...
                            if (vd.getAbsTraveledPath() >= count + 7){
                                vc.setSpeed(-1);
                            }
                            if (vd.getAbsTraveledPath() >= count + 8){
                                angle = 1000;
                            }
                            if (vd.getAbsTraveledPath() >= count + 15){
