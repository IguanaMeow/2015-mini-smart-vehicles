...
// With setSpeed you can set a desired speed for the vehicle in the range of -2.0 (backwards) .. 0 (stop) .. +2.0 (forwards)
                        ...
                        if (vd.getAbsTraveledPath() >= count + 5 && sbd.getValueForKey_MapOfDistances(0) < 0 && (sbd.getValueForKey_MapOfDistances(4) > 8 || sbd.getValueForKey_MapOfDistances(4) < 0) && park == false && rearObjectDetected == false){
                        ...
                        if (rearObjectDetected == true){
                         ...
                         if (park == true && rearObjectDetected == false){
                            ...
                            if (vd.getAbsTraveledPath() >= count && vd.getAbsTraveledPath() <=count + 8.8){
                                cout << "Moving forward in parking" << endl;
                                subtractPark = count + 10.09;
                                vc.setSpeed(1);
                            }
                            if (vd.getAbsTraveledPath() >= count + 8.8 && vd.getAbsTraveledPath() <= count + 20.5){
                                 cout << "Setting speed -1 in parking" << endl;
                                countParkDistance = vd.getAbsTraveledPath();
                                vc.setSpeed(-1);
                            }
                            if (vd.getAbsTraveledPath() >= count + 10 && vd.getAbsTraveledPath() <= count + 14){
                                 cout << "Setting angle to right in parking" << endl;
                                angle = 100000;
                            }
                            if (vd.getAbsTraveledPath() >= count + 14 && vd.getAbsTraveledPath() <= count + 17){
                                cout << "Setting angle to 0 in parking" << endl;
                                angle = 0;
                            }
                            if (vd.getAbsTraveledPath() >= count + 16 && vd.getAbsTraveledPath() <= count + 20.5){
                            ...
                            if (vd.getAbsTraveledPath() >= count + 16.9 && (sbd.getValueForKey_MapOfDistances(1) > 0 && sbd.getValueForKey_MapOfDistances(1) <= 2.2) && park == true){
                            ...
                            if (smallspace == true && vd.getAbsTraveledPath() <= count + 22){
                                cout << "Small space is now true!" << endl;
   
                                
                                if (vd.getAbsTraveledPath() >= count + 16.8 && vd.getAbsTraveledPath() <= count + 19.5){
                                    angle = 100000;
                                    vc.setSpeed(1);
                                    cout << "1" << endl;                                   
                                }
                           
                                if (vd.getAbsTraveledPath() >= count + 19.5 && vd.getAbsTraveledPath() <= count + 21){
                                    angle = -100000;
                                    cout << "2" << endl;                            
                                    vc.setSpeed(-1);
                                }
                                                              
                                if (vd.getAbsTraveledPath() >= count + 21 && vd.getAbsTraveledPath() <= count + 22){
                                    angle = 1000000;
                                    vc.setSpeed(1);
                                    cout << "3" << endl;
                                }
                            ...
                            //Emergancy break
                            if (vd.getAbsTraveledPath() >= count + 24 && (sbd.getValueForKey_MapOfDistances(1) < 2.8 || sbd.getValueForKey_MapOfDistances(1) <= 0)){
                            ...
                            //Emergancy break
                            if (vd.getAbsTraveledPath() >= count + 24 && (sbd.getValueForKey_MapOfDistances(3) < 2 || sbd.getValueForKey_MapOfDistances(3) < 0)){
