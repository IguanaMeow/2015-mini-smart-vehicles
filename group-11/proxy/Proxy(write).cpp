...
namespace msv {
    ...
    // variables used for adressing serial port and steeringData: 
    int fd, angle, counter=0;   
    const char* z = "";  

    // struct used for serial communication:
    ...
    // Opens a serial communication to a given port (ACM0) on the Arduino: 
    int openSerial() {
    ...
    // sends a number (0, 1 and 2) which the LLB decides
    // which servo value to write, based on corresponding ASCII value:
    ...
    /* Function to read incoming sensor data */
    ...
    ModuleState::MODULE_EXITCODE Proxy::body() 
    {
        ...
        while (getModuleState() == ModuleState::RUNNING) 
        {
            ...
            //VehicleData vc = containerVehicleData.getData<VehicleData>();
		...
		z = "c";
            ...
            /* Send ASCII value of z (angle) and port adress */
            writeByte(z, fd);  
