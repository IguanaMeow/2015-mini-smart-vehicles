...
namespace msv {
    ...
    void LaneDetector::processImage() {
        ...
        Point pt7;  /*LeftMid Arrow Start*/             Point pt8;  /*LeftTop Arrow End*/
        Point pt9;  /*LeftMid Arrow End*/
      ...
      Vec3b botleftLaneColor = mat_img.at<Vec3b>(pt5);
       ...
       Vec3b topTLaneColor = mat_img.at<Vec3b>(pt8);
        while(pt7.x != 0){
            pt8.x = pt8.x - 1;
            topTLaneColor = mat_img.at<Vec3b>(pt8);
            if(topTLaneColor.val[0] == 255 && topTLaneColor.val[1] == 255 && topTLaneColor.val[2] == 255){
                break;
            }
        }
         drawLine(mat_img, pt6,pt8, 1, 8, 240, 206, 81); //Left Top Arrow
        ...
        angle = -10.0;              //turns right
        sd.setExampleData(angle);  //sends the steering data to the driver.cpp code
        }
        else if(pt5.x > 190 || pt8.x > 200 || pt9.x > 190){
        angle = +16.0;              //turns left
